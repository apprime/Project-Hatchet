...
namespace Dominion.Data.MySql
{
    //TODO(apprime): Investigate how to Handle synchronicity in DB (Lock/Release assets)
    /// <summary>
    ...
    /// <summary>
    /// This Context represents a static container for an instace of a database object
    /// UserDbContext connects to the identity database and handles user authentication and authorization
    /// </summary>
    public class UserDbContext : MySQLDatabase
    {
        public UserDbContext() : base("identity") {}

        public static UserDbContext Create() { return new UserDbContext(); }
    }


    /// <summary>
    /// This Context represents a static container for an instace of a database object
    /// DominionDbContext connects to the main database that stores all game related data
    /// </summary>  
    public class DominionDbContext : MySQLDatabase
    {
        public DominionDbContext() : base("main") {}

        public static DominionDbContext Create() { return new DominionDbContext(); }
    }
}